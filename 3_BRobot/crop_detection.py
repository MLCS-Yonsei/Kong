    ...
    with tf.Session(graph=detection_graph) as sess:
        ...
        while (True):
            ...
            if len(right_clicks) == 2:
                ...
                image_process = detect_objects(cropped_img, sess, detection_graph, mot_tracker, img_to_color, face_detect, face_queue, gender_queue, age_queue)
            ...
            cv2.imshow(window_name, cv2.resize(frame, (1300, 800)))
